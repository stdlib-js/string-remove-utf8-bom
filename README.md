...
```javascript
removeUTF8BOM = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-remove-utf8-bom@v0.0.9-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/string-remove-utf8-bom@v0.0.9-umd/browser.js"></script>
```
